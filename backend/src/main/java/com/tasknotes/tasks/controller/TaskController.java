...
public class TaskController {
    ...
    @GetMapping("/api/categorias/{categoryId}/tarefas")
    ...
    @PostMapping("/api/categorias/{categoryId}/tarefas")
    ...
    @PatchMapping("/api/tarefas/{id}/status")
    ...
    @PatchMapping("/api/tarefas/{id}/priority")
    ...
    @PutMapping("/api/categorias/{categoryId}/tarefas/reorder")
